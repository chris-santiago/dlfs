...
class NNRegressor(LinearRegressor):
    ...
    def __init__(
        ...
        super().__init__(
            learning_rate, batch_size, n_iter, return_losses, return_weights, seed
        )
    ...
    def _get_loss_gradients(self) -> "NNRegressor":
        ...
        dO1_dN1 = sigmoid(self._forward_info["N1"]) * (
            1 - sigmoid(self._forward_info["N1"])
        )
    ...
    def fit(
        ...
        Tuple[List[float], Dict[str, np.ndarray], List[float]],
        List[float],
